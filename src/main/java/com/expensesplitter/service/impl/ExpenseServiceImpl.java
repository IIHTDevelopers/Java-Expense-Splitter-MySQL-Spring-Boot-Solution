...
public class ExpenseServiceImpl implements ExpenseService {
	...
	public List<ExpenseDTO> listExpensesByUserId(Long userId) {
		...
		List<Expense> paidExpenses = expenseRepository.findByPaidById(userId);
		List<Expense> sharedExpenses = expenseRepository.findBySharedWithId(userId);
		List<Expense> allExpenses = Stream.concat(paidExpenses.stream(), sharedExpenses.stream()).distinct()
